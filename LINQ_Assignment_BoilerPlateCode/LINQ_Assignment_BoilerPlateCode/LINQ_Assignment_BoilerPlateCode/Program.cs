...
namespace LINQ_Assignment_BoilerPlateCode
{
    class Program
    {
        ...
        {
            // TODO: Write LINQ query here
            var query = from e in employees join p in projects on e.Id equals p.EmployeeId
        ...
        {
            // TODO: Write LINQ query here
            return employees.Where(e => !projects.Any(p => p.EmployeeId == e.Id)).ToList();
            throw new NotImplementedException();
        }
        ...
        {
            // TODO: Write LINQ query here
            return employees.GroupBy(e => e.Department).Select(g => new DepartmentTopEmployees
                {
                    Department = g.Key,
