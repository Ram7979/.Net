...
public class PatientBill{
    ...
    public static void Register(){
        ...
        if (billObj.BillId == ""){
            Console.WriteLine("Validate BillId is non-empty");
            return;
        }
        ...
        billObj.FinalPay = billObj.GrossAmount - billObj.DiscountAmount;
        ...
        Console.WriteLine("Final Payable: " + billObj.FinalPay);
    }
    ...
    public static void View()
    {
        ...
        Console.WriteLine("Final Payable: " + LastBill.FinalPay);
    }
